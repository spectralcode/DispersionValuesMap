...
void LinePlot::setVerticalLineAVisible(bool visible) {
	this->lineA->setVisible(visible);
}

void LinePlot::setVerticalLineBVisible(bool visible) {
...
void LinePlot::setVerticalLineA(double xPos) {
	this->lineA->point1->setCoords(xPos, 0);
	this->lineA->point2->setCoords(xPos, 1);
	this->replot();
}

void LinePlot::setVerticalLineB(double xPos) {
